<?php
/**
 * 500 — customer-facing error page.
 *
...
<head>
    ...
    <title>Something went wrong on our side. &middot; <?= $brandName ?></title>
...
<body class="bg-shell text-ink">
    <main class="rs-shell flex min-h-screen max-w-3xl flex-col justify-center py-20">
        <p class="rs-eyebrow">Error 500</p>
        ...
        <p class="mt-5 max-w-lg text-lg leading-relaxed text-ink-muted">
            This one is ours, not yours. The problem has been logged and the team will look at it — nothing you were doing has been lost.
        </p>
