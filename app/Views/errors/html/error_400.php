<?php
/**
 * 400 — customer-facing error page.
 *
...
<head>
    ...
    <title>That request did not look right. &middot; <?= $brandName ?></title>
...
<body class="bg-shell text-ink">
    <main class="rs-shell flex min-h-screen max-w-3xl flex-col justify-center py-20">
        <p class="rs-eyebrow">Error 400</p>
        ...
        <p class="mt-5 max-w-lg text-lg leading-relaxed text-ink-muted">
            Something in the request was incomplete or malformed. Going back and trying again usually clears it.
        </p>
